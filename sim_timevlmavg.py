...
time.sleep(2)
#if you dont want it to download 2 candles, it should not overlap i.e. start at 0935, not 36
today=datetime.datetime.strptime("20220816_0935",'%Y%m%d_%H%M')
...
while i<79:
    ...
    time.sleep(1)
    today += datetime.timedelta(minutes=5)
    i+=1
